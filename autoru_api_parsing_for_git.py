# Данный код предназначен для парсинга данных с сайта auto.ru через внутренний api сайта
# Собираются марки, модели, поколение, тип привода
# Данные собираются в MySQL базу функцией insert_to_sql
# Конфиденциальные данные хранятся в файле local_settings
# Для предотвращения срабатывания блокировки используются случайные User_Agent и время меджу запросами sleep(randint(a, b))
# Не настроено логирование, т.к. на тот момент небыло необходимости
